    ...
    schemas: {
      ...
      FicheRenseignementEntreprise: {
        ...
        example: {
          ...
          maitre_apprentissage: {
            ...
            niveau_diplome: '7 Master, dipl�me d''�tudes approfondies, dipl�me d''�tudes sup�rieures sp�cialis�es, dipl�me d''ing�nieur',
      ...
      MaitreApprentissage: {
        ...
        properties: {
          ...
          niveau_diplome: { type: 'string', description: 'Niveau du dipl�me ou titre le plus �lev� obtenu', example: '7 Master, dipl�me d''�tudes approfondies, dipl�me d''�tudes sup�rieures sp�cialis�es, dipl�me d''ing�nieur' },
