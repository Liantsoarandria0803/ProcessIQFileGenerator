...
export type ReporterRole = 'admission' | 'rh' | 'commercial' | 'student' | 'staff' | 'admin' | 'super_admin' | 'unknown';
...
const BugReportSchema = new Schema<IBugReport>(
  {
    ...
    reporterRole: {
      type: String,
      enum: ['admission', 'rh', 'commercial', 'student', 'staff', 'admin', 'super_admin', 'unknown'],
      default: 'unknown',
      index: true,
    },
