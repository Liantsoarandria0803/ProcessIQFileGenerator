...
const OpcoSubmissionSchema = new Schema<IOpcoSubmission>(
  {
    ...
    montantTotal: { type: Number, default: null, min: 0 },
    status: {
      type: String,
      enum: ['BROUILLON', 'EN_PREPARATION', 'PRET_A_ENVOYER', 'ENVOYE', 'EN_ATTENTE_VALIDATION', 'COMPLEMENT_DEMANDE', 'ACCEPTE', 'REFUSE', 'REFUSE_DEFINITIF', 'ANNULE', 'CLOTURE', 'EN_REVISION'],
      default: 'BROUILLON',
      index: true
    },
    dateLimiteEnvoi: { type: Date, default: null, index: true },
    delayStatus: { type: String, default: null, maxlength: 255 },
